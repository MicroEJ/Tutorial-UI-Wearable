...
public class Progress extends Widget implements MotionAnimationListener {
	...
	protected void renderContent(GraphicsContext g, int contentWidth, int contentHeight) {
		...
		/**
		 * STEP 6: Draw the progress bar.
		 *
		 * Objective: Learn how to implement the rendering of widgets by using the MicroUI API.
		 *
		 * 1. Browse the API of class Painter (ej.microui.display.Painter) and class ShapePainter
		 * (ej.drawing.ShapePainter), and look for good candidates for drawing a progress bar.<br>
		 * 2. You can use the variables defined below to draw a progress bar.
		 *
		 * Note: maybe the simpler approach is to draw an horizontal progress bar using rectangles (see the method
