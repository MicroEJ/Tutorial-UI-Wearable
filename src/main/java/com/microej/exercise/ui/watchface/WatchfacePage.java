...
public class WatchfacePage extends Page {
	...
	public void populateStylesheet(CascadingStylesheet stylesheet) {
		...
		/**
		 * STEP 2: Change the look of the digital watchface.
		 *
		 * Objective: Learn how to set style attributes to widgets.
		 *
		 * 1. Change the color of the background of the watchface.<br>
		 * 2. Use the medium font for the hour:minute of the digital clock.<br>
		 * 3. Use the medium font for the seconds of the digital clock.<br>
		 * 4. Make the digital clock to be horizontally left-aligned and vertically bottom-aligned.<br>
		 * 5. Set the text color of the step count to be gray (see ej.microui.display.Colors).<br>
		 * 6. Set the icon color of the heart rate to be white.
		 */
